...
class ChildNotesScreen extends StatefulWidget {
  ...
  const ChildNotesScreen({super.key, required this.childId});
...
class _ChildNotesScreenState extends State<ChildNotesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('ملاحظات الطفل'),
          centerTitle: true,
          elevation: 0,
        ),
          ...
          builder: (context, childSnap) {
            ...
            return Column(
              children: [
                  ...
                  child: StreamBuilder<List<NoteModel>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasError) {
                        return _buildErrorState(isSmallScreen, padding);
                      }
                      ...
                      return RefreshIndicator(
                        onRefresh: () async {
                          // Stream is live-updating; no manual refresh needed
                        },
                ...
                _buildAddNoteSection(isSmallScreen, childName),
              ],
            );
          },
        ),
  ...
  Widget _buildErrorState(bool isSmallScreen, double padding) {
    return Center(
      child: Padding(
        padding: EdgeInsets.all(padding),
        child: Column(
          ...
          children: [
            Icon(Icons.error_outline, size: isSmallScreen ? 48 : 64, color: AppColors.error),
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.notes_rounded,
                    size: isSmallScreen ? 50 : 64, color: AppColors.textDisabled),
              ),
              ...
              Text(
                'ستظهر ملاحظات المعلمة هنا عند إرسالها',
                textAlign: TextAlign.center,
                style: TextStyle(
  ...
  Widget _buildNoteCard(NoteModel note, bool isSmallScreen) {
    final auth = context.read<AuthProvider>();
    final currentUserId = auth.currentUser?.id;
    final isFromParent = currentUserId != null && note.authorId == currentUserId;
    final statusLabel = isFromParent ? 'مرسلة' : 'من المعلمة';
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.check_circle_rounded,
                          size: isSmallScreen ? 12 : 14, color: AppColors.success),
            ...
            Row(
              children: [
                Icon(Icons.access_time_rounded,
                    size: isSmallScreen ? 12 : 14, color: AppColors.textDisabled),
                const SizedBox(width: 4),
                Text(
                  note.timestampText,
                  style: TextStyle(
  ...
  Widget _buildAddNoteSection(bool isSmallScreen, String childName) {
    return Container(
      padding: EdgeInsets.all(isSmallScreen ? 12 : 16),
      decoration: BoxDecoration(
        color: Colors.white,
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'أرسل ملاحظة للمعلمة عن $childName...',
  ...
  Future<void> _addNote() async {
    ...
    final note = NoteModel(
      ...
      isSentToParent: false, // ملاحظة من ولي الأمر للمعلمة
